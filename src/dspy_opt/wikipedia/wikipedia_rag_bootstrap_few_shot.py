"""Optimized Wikipedia RAG Pipeline using the Bootstrap-Few-Shot optimizer."""
...
def main() -> None:
    ...
    with open("wikipedia_rag_bootstrap_few_shot_config.yml", "r") as f:
