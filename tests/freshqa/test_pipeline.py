"""Tests for the FreshQA pipeline."""
...
class TestPipeline:
    """FreshQA pipeline coverage."""

    def test_rag_pipeline_success_path(self, mocker: pytest_mock.MockFixture) -> None:
        """Validate the happy path through the FreshQA RAG pipeline."""
        module = importlib.import_module("dspy_opt.freshqa.freshqa_rag_module")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("dspy_opt.freshqa.freshqa_rag_mipro", "FreshQARAG", {}),
            ("dspy_opt.freshqa.freshqa_rag_copro", "FreshQARAG", {}),
            ("dspy_opt.freshqa.freshqa_rag_simba", "FreshQARAG", {}),
            (
                "dspy_opt.freshqa.freshqa_rag_bootstrap_few_shot",
                "FreshQARAG",
                {
                    "optimizer": {
            ...
            ("dspy_opt.freshqa.freshqa_rag_gepa", "FreshQARAG", {}),
            (
                "dspy_opt.freshqa.freshqa_rag_evaluation",
                "FreshQARAG",
                {
                    "dataset": {
                        "name": "name",
    ...
    def test_indexing_script_runs(self, mocker: pytest_mock.MockFixture) -> None:
        ...
        mocker.patch(
            "yaml.safe_load",
            return_value={
                "dataset": {"name": "name", "subset": "subset", "split": "train"},
                "metadata_schema": {},
        ...
        runpy.run_module("dspy_opt.freshqa.freshqa_indexing", run_name="__main__")
