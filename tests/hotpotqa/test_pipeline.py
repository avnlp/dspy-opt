"""Tests for the HotpotQA pipeline."""
...
class TestPipeline:
    """HotpotQA pipeline coverage."""

    def test_rag_pipeline_success_path(self, mocker: pytest_mock.MockFixture) -> None:
        """Validate the happy path through the HotpotQA RAG pipeline."""
        module = importlib.import_module("dspy_opt.hotpotqa.hotpotqa_rag_module")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("dspy_opt.hotpotqa.hotpotqa_rag_mipro", "HotpotQARAG", {}),
            ("dspy_opt.hotpotqa.hotpotqa_rag_copro", "HotpotQARAG", {}),
            ("dspy_opt.hotpotqa.hotpotqa_rag_simba", "HotpotQARAG", {}),
            (
                "dspy_opt.hotpotqa.hotpotqa_rag_bootstrap_few_shot",
                "HotpotQARAG",
                {
                    "optimizer": {
            ...
            ("dspy_opt.hotpotqa.hotpotqa_rag_gepa", "HotpotQARAG", {}),
            (
                "dspy_opt.hotpotqa.hotpotqa_rag_evaluation",
                "HotpotQARAG",
                {
                    "dataset": {
                        "name": "name",
    ...
    def test_indexing_script_runs(self, mocker: pytest_mock.MockFixture) -> None:
        ...
        runpy.run_module("dspy_opt.hotpotqa.hotpotqa_indexing", run_name="__main__")
