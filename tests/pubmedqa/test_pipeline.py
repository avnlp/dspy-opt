"""Tests for the PubMedQA pipeline."""
...
class TestPipeline:
    """PubMedQA pipeline coverage."""

    def test_rag_pipeline_success_path(self, mocker: pytest_mock.MockFixture) -> None:
        """Validate the happy path through the PubMedQA RAG pipeline."""
        module = importlib.import_module("dspy_opt.pubmedqa.pubmedqa_rag_module")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("dspy_opt.pubmedqa.pubmedqa_rag_mipro", "PubMedQARAG", {}),
            ("dspy_opt.pubmedqa.pubmedqa_rag_copro", "PubMedQARAG", {}),
            ("dspy_opt.pubmedqa.pubmedqa_rag_simba", "PubMedQARAG", {}),
            (
                "dspy_opt.pubmedqa.pubmedqa_rag_bootstrap_few_shot",
                "PubMedQARAG",
                {
                    "optimizer": {
            ...
            ("dspy_opt.pubmedqa.pubmedqa_rag_gepa", "PubMedQARAG", {}),
            (
                "dspy_opt.pubmedqa.pubmedqa_rag_evaluation",
                "PubMedQARAG",
                {
                    "dataset": {
                        "name": "name",
    ...
    def test_indexing_script_runs(self, mocker: pytest_mock.MockFixture) -> None:
        ...
        runpy.run_module("dspy_opt.pubmedqa.pubmedqa_indexing", run_name="__main__")
